...
- `ITY.KR/u/{사용자 아이디}` 주소 기반의 사용자 등록
  - 사용자 예제: [ITY.KR/u/ity](https://ity.kr/u/ity), [ITY.KR/u/tests/](https://ity.kr/u/tests)
  - [사용자 등록 예제](https://github.com/OUS-KR/ITY.KR/issues/1)
- `ITY.KR/@{사용자 아이디}` 형태의 짧은 주소 지원
  - 사용자 예제: [ITY.KR/@ity](https://ity.kr/@ity), [ITY.KR/@tests](https://ity.kr/@tests)
...
- `ITY.KR/u/{사용자 아이디}/{글 경로}` 형태의 글 작성
  - 마크다운 문법: [마크다운 문법](https://github.com/OUS-KR/ITY.KR?tab=readme-ov-file#%EB%A7%88%ED%81%AC%EB%8B%A4%EC%9A%B4-%EB%AC%B8%EB%B2%95-%EC%98%88%EC%8B%9C), [마크다운 문법 예제](https://ity.kr/@ity/articles/md_example)
...
[마크다운 문법 예제](https://ity.kr/@ity/articles/md_example)
